...
public class Update extends javax.swing.JFrame {
    ...
    public Update(Resources d) {
        ...
        stok.setText(barang.getStok_barang());
    ...
    private void initComponents() {
        ...
        welcomeJL.setText("Update Barang");
        ...
        jLabel5.setText("Update Barang in the table");

        buttonGradient1.setForeground(new java.awt.Color(0, 0, 0));
        buttonGradient1.setText("Update Darang");
    ...
    private void buttonGradient1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonGradient1ActionPerformed
        ...
        if (nama_barang.isEmpty()) {
            JOptionPane.showMessageDialog(this, "nama tidak bolleh kosong");
            kodeBarang.requestFocus();
        }else{
            try {
                Connection c = Koneksi.MySQl();
                Statement st = c.createStatement();
                String query = "UPDATE barang SET nama_barang='"+nama_barang+"', stok_barang='"+stok_barang+"', harga_barang='"+harga_barang+"' WHERE kode_barang="+barang.getKode_Barang()+"";
